...
export const PrincipalInvestigatorCreate: React.FC = () => {
    const {
        saveButtonProps,
        register,
        control,
        formState: { errors },
    } = useForm<IPrincipalInvestigator, HttpError, Nullable<IPrincipalInvestigator>>();

    // const { autocompleteProps } = useAutocomplete<IPrincipalInvestigator>({
    //     resource: "principal-investigators",
    // });
