...
import { IObservation } from '@/interfaces/dataforge/IObservation'
import { useState } from 'react'

export const GroundwaterLevelObservationCreate: React.FC = () => {
  const {
    saveButtonProps,
    register,
    control,
    formState: { errors },
  } = useForm<IObservation, HttpError, Nullable<IObservation>>()
