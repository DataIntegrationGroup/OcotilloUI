 ...
 * note_type
 */
export type NoteType = 'Access' | 'Directions' | 'Communication' | 'Construction' | 'Maintenance' | 'Historical' | 'General' | 'Water' | 'Water Quality' | 'Sampling Procedure' | 'Coordinate' | 'OwnerComment' | 'Site Notes (legacy)';
 ...
 */
export type WellConstructionMethod = 'Unknown' | 'Air-Rotary' | 'Bored or augered' | 'Cable-tool' | 'Hydraulic rotary (mud or water)' | 'Air percussion' | 'Reverse rotary' | 'Driven' | 'Other (explain in notes)';

/**
 * well_pump_type
 */
export type WellPumpType = 'Submersible' | 'Jet' | 'Line Shaft' | 'Hand' | 'Windmill';
