 ...
 * note_type
 */
export type NoteType = 'Access' | 'Directions' | 'Communication' | 'Construction' | 'Maintenance' | 'Historical' | 'General' | 'Water' | 'Sampling Procedure' | 'Coordinate' | 'OwnerComment' | 'Site Notes (legacy)';
