...
export const fetcher = async (url: string, options?: RequestInit) => {
    ...
    console.log('fetcher', `${settings.subsurface_api_url}/${url}`);
    return fetch(`${settings.subsurface_api_url}/${url}`, {
        ...options,
        headers: {
            ...options?.headers,
...
export const subsurfaceDataProvider: DataProvider = {
    ...
    getApiUrl: () => settings.subsurface_api_url,
    deleteOne: () => {
